...
Do not check sensitive information (like API keys, database passwords, or RCON passwords) into your templates. Instead, use [environment variables](interpolation) which the orchestrator will automatically inject into your configs during the preparation phase.
</Callout>
